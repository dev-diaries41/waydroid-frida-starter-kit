Java.perform(function () {
    try {
        var AndroidImageProxy = Java.use("androidx.camera.core.AndroidImageProxy");
        var IntentSenderRequest = Java.use("androidx.activity.result.IntentSenderRequest");
        var ActivityResult = Java.use("androidx.activity.result.ActivityResult");
        var ImageUtil = Java.use("androidx.camera.core.internal.utils.ImageUtil");
        var ImageProxy = Java.use("androidx.camera.core.ImageProxy");
